...
export class UsersComponent implements OnInit {
  ...
  constructor(private _ApiService: ApiService , private _Router: Router, private _AppComponent: AppComponent ) {
    this._AppComponent.activeU = 'active';
  ...
  okUp(data: any){
    if(this.passwordU == '' || $('.rootSelectU').val() == '' || $('.controlSelectU').val() == '' || this.passwordU == undefined || this.nameU == undefined || this.nameU == '' || $('.rootSelectU').val() == undefined || $('.controlSelectU').val() == undefined ) {
  ...
  addUser0(data: any){
    if(this.password == '' || $('.rootSelect').val() == '' || $('.controlSelect').val() == '' || this.password == undefined || $('.rootSelect').val() == undefined || $('.controlSelect').val() == undefined || this.name == undefined || this.name == '' ) {
      alert('Please . Make sure the password, the Branch, and the Permission are entered');
    } else {
      $('.loading').css({display: 'block'});
